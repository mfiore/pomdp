...
${OBJECTDIR}/AssembleBracket.o: AssembleBracket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssembleBracket.o AssembleBracket.cpp

${OBJECTDIR}/AttachBracket.o: AttachBracket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AttachBracket.o AttachBracket.cpp

${OBJECTDIR}/CleanSurface.o: CleanSurface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CleanSurface.o CleanSurface.cpp
...
${OBJECTDIR}/DrinkWater.o: DrinkWater.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DrinkWater.o DrinkWater.cpp

${OBJECTDIR}/GetObject.o: GetObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GetObject.o GetObject.cpp

${OBJECTDIR}/GlueSurface.o: GlueSurface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GlueSurface.o GlueSurface.cpp

${OBJECTDIR}/Handover.o: Handover.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Handover.o Handover.cpp
...
${OBJECTDIR}/PlaceObject.o: PlaceObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlaceObject.o PlaceObject.cpp

${OBJECTDIR}/Pomdp.o: Pomdp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pomdp.o Pomdp.cpp
...
${OBJECTDIR}/ReorderTable.o: ReorderTable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReorderTable.o ReorderTable.cpp

${OBJECTDIR}/Saphari.o: Saphari.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../devel/src/eigen -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Saphari.o Saphari.cpp
