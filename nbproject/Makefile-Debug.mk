...
${OBJECTDIR}/StartWashingMachine.o: StartWashingMachine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../devel/src/eigen/Eigen -I../../devel/src/eigen -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StartWashingMachine.o StartWashingMachine.cpp

${OBJECTDIR}/TakeObject.o: TakeObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../devel/src/eigen/Eigen -I../../devel/src/eigen -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TakeObject.o TakeObject.cpp
...
${OBJECTDIR}/WashLaundry.o: WashLaundry.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../devel/src/eigen/Eigen -I../../devel/src/eigen -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WashLaundry.o WashLaundry.cpp

${OBJECTDIR}/WashLaundryFull.o: WashLaundryFull.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../devel/src/eigen/Eigen -I../../devel/src/eigen -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WashLaundryFull.o WashLaundryFull.cpp
